...
var watchList = [
  ...
  function getRating(watchList){
    // Only change code below this line
    var averageRating = watchList.filter(stuff => stuff.Director == "Christopher Nolan");
    var numRating = averageRating.map(num => Number(num.imdbRating));
    var theAverage = numRating.reduce((one, two) => one + two) / numRating.length;
